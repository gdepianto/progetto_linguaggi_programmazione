...
?-nfa_regexp_comp(FA_Id, RE):
    ...
    "nfa_delta" generati attraverso l'algoritmo di costruzione di Thompson e gli stati finali ed iniziali dell'automa ("nfa_final" e "nfa_initial").
    ...
    Per questo motivo sono stati scritti predicati ausiliari in modo da facilitare la sostituzione del nuovo ID generato, con quello originale (RENAME).
